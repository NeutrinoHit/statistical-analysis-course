...
::: incremental
- Точечная оценка $\widehat\varepsilon=N_{\mathrm{sel}}/N_{\mathrm{gen}}$ остаётся разумной как [оценка методом максимального правдоподобия](09_maximum_likelihood.html#/метод-максимального-правдоподобия).
