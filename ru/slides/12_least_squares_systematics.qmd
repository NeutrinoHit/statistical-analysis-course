...
- Число $c$ зависит от того, какую область мы строим. Это будет отдельная тема в лекции [Качество согласия и статистическая значимость](13_goodness_of_fit_and_significance.qmd).
