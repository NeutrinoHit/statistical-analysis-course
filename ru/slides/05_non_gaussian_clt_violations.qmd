...
::: incremental
- В лекции [про ЦПТ](04_central_limit_theorem.qmd) мы увидели, как сумма бесконечного числа независимых вкладов описывается гауссовым распределением.
...
- Тогда, как мы видели в [лекции про характеристические функции](03_characteristic_functions.qmd), сумма
$$
S_n=\sum_{i=1}^n X_i
$$
имеет распределение:
...
## Интерактив: среднее Коши не становится гауссом {#applet-cauchy-mean}
...
## Интерактив: распределение Ландау {#applet-landau}
...
## Интерактив: коррелированная ошибка не исчезает {#applet-correlated-error}
...
## Интерактив: смесь двух гауссов {#applet-gaussian-mixture}
...
## Интерактив: отношение гауссовых величин {#applet-gaussian-ratio}
