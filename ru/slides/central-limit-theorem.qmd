...
- В лекции [о случайных величинах и распределениях](random-distributions.qmd#cdf) мы ввели кумулятивную функцию распределения:
$$
\begin{aligned}
...
## Задача 4. Квантили и отклонения в сигмах
...
**Подсказка.** Используйте формулу $x_\alpha=\mu+z_\alpha\sigma$ и определение $z=(x-\mu)/\sigma$.

## Задача 5. Усреднение независимых измерений
...
**Подсказка.** Используйте веса $w_i=1/\sigma_i^2$ и для разности двух измерений формулу $\sigma_d=\sqrt{\sigma_1^2+\sigma_2^2}$.

## Задача 6. Линейное распространение ошибки
...
**Подсказка.** Сначала найдите производную $dv/dt$.
