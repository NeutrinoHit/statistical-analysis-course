...
Из лекции [о двумерном гауссе](07_two_dimensional_gaussian.qmd) мы знаем форму многомерного гаусса:
$$
p(\boldsymbol\beta)
\propto
\exp\!\left[
...
## Геометрия ошибок: профилирование по $a$ {#applet-fit-geometry}
...
## Интерактив: прямая, ошибки и выброс {#applet-line-outlier}
