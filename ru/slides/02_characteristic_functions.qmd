...
\varphi_X(t)=e^{-|t|}.
$$
Это легко проверить, вычислив интеграл по теореме о вычетах.
...
\right]^n.
$$
- В пределе при $n\to\infty$ имеем
$$
\lim\limits_{n\to\infty} \varphi_{Z_n}(t) = e^{-t^2/2}.
$$
- это характеристическая функция стандартного гауссова распределения.
- Получаем фундаментальное утверждение:
сумма бесконечно большого числа независимых и одинаково распределённых величин с конечной дисперсией стремится к гауссову распределению.
