(() => {
  ...
  const lectures = [
    {number: "01", file: "01_introduction.html", enFile: "lecture-01-introduction.html", ru: "Мотивация и обзор курса", en: "Motivation and course overview", applets: [
      ["applet-gaussian-fit", "Псевдоданные и фит", "Gaussian pseudodata and fit"]
    ]},
    {number: "03", file: "03_characteristic_functions.html", ru: "Характеристические функции", en: "Characteristic functions", applets: [
      ["applet-fourier-clt", "Гауссов предел в пространстве Фурье", "Gaussian limit in Fourier space"]
    ]},
    {number: "04", file: "04_central_limit_theorem.html", ru: "Центральная предельная теорема", en: "Central limit theorem", applets: [
    ...
    {number: "05", file: "05_non_gaussian_clt_violations.html", ru: "Когда гауссов предел не возникает", en: "When the Gaussian limit fails", applets: [
    ...
    {number: "06", file: "06_error_propagation.html", ru: "Распространение ошибок", en: "Error propagation", applets: [
    ...
    {number: "07", file: "07_two_dimensional_gaussian.html", ru: "Двумерное гауссово распределение", en: "Two-dimensional Gaussian distribution", applets: [
    ...
    {number: "08", file: "08_monte_carlo_method.html", ru: "Метод Монте-Карло", en: "Monte Carlo method", applets: [
    ...
    {number: "09", file: "09_maximum_likelihood.html", ru: "Максимальное правдоподобие", en: "Maximum likelihood", applets: [
      ["applet-binomial-likelihood", "Биномиальное правдоподобие", "Binomial likelihood"]
    ]},
    {number: "10", file: "10_estimator_properties_profile_likelihood.html", ru: "Свойства оценок и профильное правдоподобие", en: "Estimator properties and profile likelihood", applets: [
    ...
    {number: "11", file: "11_least_squares_linear_fit.html", ru: "Метод наименьших квадратов", en: "Least-squares method", applets: [
    ...
    {number: "13", file: "13_goodness_of_fit_and_significance.html", ru: "Качество согласия и значимость", en: "Goodness of fit and significance", applets: [
